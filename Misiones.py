...
class Misiones:
    ...
    def ejecutar_matriz_4(self):
        ...
        self.robot.navegacion.giro_preciso_pd(-90)
        self.robot.mecanismos.elevador_delantero.mover(-550, velocidad=400, wait_after=False)
        self.robot.chasis.avanzar_recto(distancia_cm=23.5)
        self.robot.chasis.avanzar_recto(-24)
        self.robot.navegacion.giro_preciso_pd(90)
        self.robot.mecanismos.garra_delantera.cerrar(400, wait_after=False)
        self.robot.chasis.avanzar_recto(distancia_cm=10)
        self.robot.navegacion.giro_preciso_pd(-90)
        self.robot.mecanismos.garra_delantera.cerrar_al_tope(velocidad=35, wait_after=False)
        self.robot.chasis.avanzar_recto(15)
        self.robot.chasis.avanzar_recto(-15)
        self.robot.navegacion.giro_preciso_pd(-90)
        self.robot.mecanismos.garra_delantera.abrir(400, wait_after=False)
        self.robot.mecanismos.elevador_delantero.mover(300)
        self.robot.chasis.avanzar_recto(-10)
        self.robot.mecanismos.elevador_delantero.mover(-300)
        self.robot.navegacion.seguidor_linea_distancia(self.sensor, velocidad_max=100, distancia_cm=15, lado="izquierda")

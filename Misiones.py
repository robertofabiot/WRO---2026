...
class Misiones:
    ...
    def agarrar_azules(self):
        ...
        self.robot.navegacion.avanzar_distancia_luego_color(self.sensor, 40, Color.BLACK, distancia_maxima_cm=70, velocidad_escaneo=200, distancia_extra_cm=4, encadenado=True)

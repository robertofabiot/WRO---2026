...
class Misiones:
    ...
    def agarrar_bloques_verdes(self):
        self.robot.chasis.avanzar_recto(27, velocidad=1000, frenado=Stop.COAST)
        self.robot.chasis.mover_motor_derecho(300, velocidad=1000)
        self.robot.navegacion.seguidor_linea_distancia(self.sensor, 1000, 23, tiempo_acomodo_ms=0)

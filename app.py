...
def cemento_y_llana():
    ...
    mi_robot.navegacion.seguidor_linea_distancia(sensor, 100, distancia_cm=89, tiempo_acomodo_ms=0, margen_cm=10)
    ...
    mi_robot.navegacion.seguidor_linea_distancia(sensor, 100, distancia_cm=69, tiempo_acomodo_ms=0, margen_cm=8)
...
def dejar_bloques_blancos():
    ...
    mi_robot.navegacion.seguidor_linea_color(sensor, 100, Color.GREEN, lado="derecha", distancia_cm=17)
...
def detectar_mosaico():
    ...
    mi_robot.navegacion.seguidor_linea_distancia(sensor, 60, 15, tiempo_acomodo_ms=0, kp=0.45, kd=1.8, k_freno=0.8) 
...
def agarrar_bloques_amarillos():
    ...
    mi_robot.navegacion.giro_preciso_pd(45)

    # Seguir hasta el cuadro amarillo
    mi_robot.navegacion.seguidor_linea_color(sensor, 100, Color.YELLOW, distancia_cm=26)
...
def dejar_bloques_amarillos():
    ...
    # Seguir la línea
    mi_robot.navegacion.seguidor_linea_distancia(sensor, 100, distancia_cm=58 , lado="izquierda", tiempo_acomodo_ms=800)
    wait(500)
...
def recoger_bloques_azules():
    ...
    # Seguir línea
    mi_robot.navegacion.seguidor_linea_distancia(sensor, 100, 50)
    ...
    mi_robot.navegacion.seguidor_linea_color(sensor, 100, Color.BLUE, distancia_cm=25)

...
def cemento_y_llana():
    ...
    mi_robot.mover_en_arco(radio_cm=12, distancia_cm=15, stop=Stop.NONE)

    # Seguidor de línea hasta cemento
    mi_robot.seguidor_linea_distancia(sensor, 100, distancia_cm=74, tiempo_acomodo_ms=0, margen_cm=2)

    # Acomodarse para cemento
    mi_robot.giro_preciso_pd(-90, margen_grados=5)
    mi_robot.mover_garra_trasera(53, velocidad=1200, wait_after=False) 
    mi_robot.avanzar_recto(-13,velocidad=1000, frenado=Stop.COAST, margen_cm=2)
    mi_robot.llevar_eje_central_al_tope("positivo", limite_potencia=100)


    # Empujar la llana
    mi_robot.avanzar_recto(9, velocidad=1000, frenado=Stop.BRAKE, margen_cm=2)
    mi_robot.mover_motor_derecho(-540, velocidad=1000, margen_grados=50) 
    mi_robot.avanzar_recto(-17, velocidad=1000, frenado=Stop.NONE, margen_cm=3) # Llana dejada
    ...
    mi_robot.seguidor_linea_distancia(sensor, 100, distancia_cm=62, tiempo_acomodo_ms=0, margen_cm=5)

    # Dejar cemento
    mi_robot.mover_motor_derecho(-410, velocidad=1000, margen_grados=270)
    mi_robot.mover_eje_central(-60, velocidad=1000, margen_grados=20) # Cemento dejado

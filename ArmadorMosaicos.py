...
class ArmadorMosaicos:
    ...
    def _armar_verde_verde(self):
        # Mandar la garra central (ahora trasera) arriba si no lo está (antes llevar_al_tope("negativo"))
        ...
        # Bajar la garra trasera (antes llevar_al_tope("positivo"))
        self.robot.garra_trasera.bajar_al_tope(velocidad=400, limite_potencia=100)
        ...
        # Soltar (Subir la jaula, antes mover -110)
        self.robot.garra_trasera.subir(110)
        ...
        self.robot.garra_trasera.subir_al_tope(limite_potencia=100)
        self.robot.garra_trasera.bajar(90)
        ...
        # Acá el robot se acomoda para quedar recto con los colores
        self.robot.garra_trasera.bajar_al_tope(velocidad=400, limite_potencia=100)
        self.robot.chasis.mover_motor_derecho(180, 1000)

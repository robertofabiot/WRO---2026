...
class ArmadorMosaicos:
    ...
    def _armar_verde_verde(self):
        ...
        self.robot.mover_en_arco(-9, distancia_cm=3.6, stop=Stop.COAST)
        self.robot.mover_en_arco(9.5, distancia_cm=2, stop=Stop.NONE) 
        self.robot.avanzar_recto(7)
        self.robot.mover_motor_izquierdo(30)
        # Soltar
        ...
        self.robot.giro_preciso(155)
        self.robot.avanzar_recto(28)
        self.robot.mover_motor_izquierdo(120)
        #Entrar
        self.robot.avanzar_recto(12)
        # self.robot.giro_preciso_pd(90, kp=2.5)
        self.robot.avanzar_recto(10, velocidad=1000)
        self.robot.cerrar_garra_delantera_al_tope(velocidad=1000, limite_potencia=100)
        self.robot.avanzar_recto(-5)
        self.robot.abrir_garra_delantera(170, velocidad=1000)
